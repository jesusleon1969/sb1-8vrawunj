    ...
    <div id="contact" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">Ponte en contacto con nuestro equipo de expertos</p>
        </div>
          ...
          <div className="space-y-8">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-600">info@brlatam.com</p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-600">+58 (412) 2225022</p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-600">Torre BRLatam<br />Caracas, Venezuela</p>
              </div>
            </div>
          </div>
        </div>
